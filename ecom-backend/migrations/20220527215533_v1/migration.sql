-- CreateEnum
CREATE TYPE "UserRoleType" AS ENUM ('admin', 'worker', 'customer');
...
-- CreateIndex
CREATE INDEX "CartItem_item_idx" ON "CartItem"("item");
...
-- AddForeignKey
ALTER TABLE "CartItem" ADD CONSTRAINT "CartItem_item_fkey" FOREIGN KEY ("item") REFERENCES "Item"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_ItemsCart_items" ADD FOREIGN KEY ("A") REFERENCES "CartItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;
